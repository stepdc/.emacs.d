;;; procolors-theme.el --- Emacs theme with a light background.
...
;;; See https://github.com/pmkary/ProColors/blob/master/pro-colors.themeX/theme.yml
;; themes:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'procolors
	...
	`(font-lock-reference-face ((,class (:foreground ,const))))
        ...
        `(highlight ((,class (:foreground ,fg3 :background ,selection))))
	...
	`(slime-repl-inputed-output-face ((,class (:foreground ,type))))
        ...
        `(lazy-highlight ((,class (:foreground ,fg1 :background ,selection :inherit bold))))
...
(provide-theme 'procolors)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; procolors-theme.el ends here
